...
| §9.5 | IMV 1 covered participants 1047-001 and 1047-002 and satisfied the first-participant rule | Invented, but arithmetically consistent — first participant randomized 24-JAN-2023 (canon), IMV 1 on 09-FEB-2023 (canon), so two participants and a Week-2 visit are plausible by then | Med |
...
| Appendix G | Participant identifiers 1047-004, 1047-007, 1047-009 through 1047-014 | **Invented.** Format follows the canonical `SSSS-NNN` convention. 1047-004 and 1047-011 are assigned the eDiary deviations; 1047-007 the missed PK sample | Med |
| Appendix G | "Fourteen participants were open to review" and SDV completed for 1047-009 through 1047-014 through Week 12 | Invented detail, consistent with the canonical randomized count and the invented enrollment timeline | Med |
