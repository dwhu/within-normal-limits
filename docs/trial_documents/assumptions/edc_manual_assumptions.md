...
| §5.1 | Site 1047 participants 1047-001, -006, -009, -011, -012, -013, -014 with the states shown; "Showing 7 of 23" | Illustrative. The total 23 matches the canonical 23 screened in `RESEARCH_SITE.md` §5; individual participant states are invented but consistent with 14 randomized / 9 screen failures / 2 early terminations | Med |
| §5.1 | eDiary flag threshold 70% over a trailing 14 days | Invented threshold | Low |
| §5.2 | Participant 1047-009 casebook: randomization number 204518, enrolled 12-JUN-2023, visit dates and study days | Invented, internally consistent with the SoA windows. Randomization number 204518 is the example value given in `STUDY_FACTS.md` §11 | Med |
